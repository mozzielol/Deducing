...
class BNN_MLP(snt.AbstractModule):
    ...
    def __init__(self, n_inputs, n_outputs, hidden_units=[], enable_cnn=False,num_task=2, init_mu=0.0, init_rho=0.0, activation=tf.nn.relu,
    ...
    def back_up_params(self):
        self.back_up_mean = self.params_mean
        self.back_up_var = self.params_var
    ...
    def restore_params_from_backup(self):
        try:
            self.params_mean = self.back_up_params
            self.params_var = self.back_up_var
